        ...
        <AnimatedSection delay={0.5} className="text-center mt-12">
          <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
            <Button className="px-8">
              ...
              >
                <path d="M15 10L19 14M19 14L15 18M19 14H9M5 14V5C5 4.46957 5.21071 3.96086 5.58579 3.58579C5.96086 3.21071 6.46957 3 7 3H14C14.5304 3 15.0391 3.21071 15.4142 3.58579C15.7893 3.96086 16 4.46957 16 5V8" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
              </svg>
